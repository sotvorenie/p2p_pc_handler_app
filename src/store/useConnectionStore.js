...
const useConnectionStore = defineStore('connection', () => {
    ...
    // информация о ПК
    const PCInfo = ref()
    // показ информации в модальном окне (информации кроме списка установленных программ информации о ПК)
    const showInModalInfo = ref('')
    // последняя отправленная команда (для вывода в модальном окне нужной информации)
